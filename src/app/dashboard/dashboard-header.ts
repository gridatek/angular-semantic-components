...
@Component({
  ...
  template: `
    <header class="flex h-16 shrink-0 items-center gap-2 border-b px-4 md:px-8">
      <button scSidebarTrigger variant="ghost" size="icon-sm" aria-label="Toggle sidebar"></button>
      <hr scSeparator orientation="vertical" class="mx-2 h-4" />
